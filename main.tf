      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:logs:eu-west-1:${local.account_id}:*/*",
            "arn:aws:dynamodb:eu-west-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:ecs:eu-west-1:${local.account_id}:*/*",
            "arn:aws:cloudwatch:eu-west-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
